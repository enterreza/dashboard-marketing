...
if df is not None and not df.empty:
    ...
    if not df_filtered.empty:
        ...
        # --- TAMBAHAN: ROUNDED CORNERS ---
        # cornerradius mengatur kelengkungan (15 adalah nilai standar yang manis)
        ...
        fig.update_yaxes(
            ...
            layer="below traces" # Grid diletakkan di bawah bar agar tidak memotong
        )
